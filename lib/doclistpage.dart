...
class DocList extends StatefulWidget {
  bool multiSelect;
  var changeMulitSelect;

  DocList(Key key, bool multiSelect,
      changeMulitSelect(bool meeters))
      : super(key: key) {
    this.multiSelect = multiSelect;
    this.changeMulitSelect = changeMulitSelect;
  }
...
class DocListState extends State<DocList> {
          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  Visibility(
                    visible: widget.multiSelect ? true : false,
                    child: IconButton(
                      icon: Icon(
                        Icons.arrow_back,
                      ...
                      onPressed: () {
                        setState(() {
                          ...
                          numDocsChecked = 0;
                          checkBoxValues = List.filled(tempcont.length, false,
                              growable: true);
                        });
                        widget.changeMulitSelect(false);
                      },
                    ),
                  ),
                  Visibility(
                    visible: widget.multiSelect ? false : true,
                    child: Text(
                      "Your Documents",
                      style: TextStyle(
                        color: Colors.black54,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    DropdownButton<String>(
                        ...
                        items:
                            sortOptions.map<DropdownMenuItem<String>>((value) {
                      ...
                      child: widget.multiSelect
                          ? Card(
                              child: ListTile(
                                ...
                                trailing: Opacity(
                                  opacity: widget.multiSelect ? 1 : 0,
                                  child: Checkbox(
                          ...
                          : FocusedMenuHolder(
                              ...
                              menuItemExtent: UIUtills()
                                  .getProportionalHeight(height: 37.5),
  ...
  showAlertDialog(BuildContext context, {int index = -1}) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: widget.multiSelect
          ? Text("All Documents will be deleted permanently.")
          : Text("Document will be deleted permanently."),
      actions: [
        cancelButton,
        continueButton,
      ],
