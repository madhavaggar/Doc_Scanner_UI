...
class _BottomNavBarV2State extends State<BottomNavBarV2> {
  ...
  final GlobalKey<DocListState> callQuitMulti = GlobalKey<DocListState>();
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      child: Scaffold(
        body: currentIndex % 2 == 0
            ? DocList(callQuitMulti, multiSelect, (change) {
                setState(() {
                  multiSelect = change;
                });
              })
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            width: UIUtills()
                                    .getProportionalWidth(width: size.width) *
                                0.17,
                          ),
                          IconButton(
                              icon: Icon(
      ...
      onWillPop: () {
        return !multiSelect
            ...
            : callQuitMulti.currentState.backPressed();
